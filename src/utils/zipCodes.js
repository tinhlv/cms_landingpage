...
export const parseZipCodeToObject = (postcodeString) => {
    ...
    const city = parseToArray[0] !== undefined ? parseToArray[0].trim() : 'unknown';
    const state = parseToArray[1] !== undefined ? parseToArray[1].trim() : 'unknown';
    const postcode = parseToArray[2] !== undefined ? parseToArray[2].trim() : 'unknown';
